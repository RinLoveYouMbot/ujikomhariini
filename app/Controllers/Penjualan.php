...
class Penjualan extends BaseController
{
    ...
    public function bayar()
    {
        if ($this->request->getMethod() == 'post') {
            ...
            $data      = [
                ...
                'PelangganID' => $this->request->getPost('PelangganID', FILTER_SANITIZE_NUMBER_INT),
                'TotalHarga'  => $this->request->getPost('subtotal', FILTER_SANITIZE_NUMBER_INT),
                ...
                'TanggalPenjualan'      => $this->request->getPost('tanggal', FILTER_SANITIZE_STRING),
                'id_user'      => session('id'),
    ...
    {
        if ($this->request->isAJAX()) {
            return DataTables::use('penjualan')->select('PenjualanID AS id, invoice, TanggalPenjualan')->make();
    ...
    public function cetak($id)
    {
        ...
        return view('penjualan/cetak_termal', ['transaksi' => $transaksi]);
    }
}
