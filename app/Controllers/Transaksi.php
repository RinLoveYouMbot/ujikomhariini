    ...
    public function stok() {
        if ($this->request->isAJAX()) {
            ...
            return DataTables::use ('tb_stok')
                ->select('tb_stok.id_stok AS id, tb_stok.jumlah, tb_stok.keterangan, tb_stok.created_at AS tanggal, produk.barcode AS barcode, NamaProduk AS item, tb_pemasok.nama_pemasok AS pemasok')
                ->join('produk', 'produk.id = id_item')
