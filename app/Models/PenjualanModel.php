...
class PenjualanModel extends Model
{
    ...
    public function invoice()
    {
        ...
        $builder = $this->builder($this->table)->selectMax('invoice')->where('TanggalPenjualan', date('Y-m-d'))->get(1)->getRow();
    ...
    {
        return $this->builder('tb_bulan_tahun')->select('bulan')->selectCount('JumlahProduk', 'total')->join('detailpenjualan', 'date_format(created_at, "%m-%Y") = bln_thn', 'left')->where('tahun', $tahun)->groupBy('bln_thn')->get()->getResult();
    }
}
