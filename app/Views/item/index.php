...
<div class="container-fluid">
    <button class="btn btn-primary mb-1 tambah "><i class="fas fa-plus"></i> Tambah Produk</button>
    <button class="btn btn-success mb-1 export-excel"><i class="fas fa-file-excel"></i> EXCEL</button>
    <!-- <a target="_blank" class="btn btn-danger mb-1 export-pdf"><i class="fas fa-file-pdf"></i> PDF</a> -->
...
<script>
    $(document).ready(function() {
        ...
        $(".export-pdf").on("click", function() {
            location.href = `${BASE_URL}item/downloadPDF`
        })
